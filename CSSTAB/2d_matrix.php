...
<body>
    <div id="content">
      ...
      <div class="main">
        <p class="codepen" data-height="265" data-theme-id="light" data-default-tab="css,result" data-user="nadine-padernal" data-slug-hash="mdPqjaz" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="mdPqjaz">
          <span>See the Pen <a href="https://codepen.io/nadine-padernal/pen/mdPqjaz">
              mdPqjaz</a> by nadine-padernal (<a href="https://codepen.io/nadine-padernal">@nadine-padernal</a>)
