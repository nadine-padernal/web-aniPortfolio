...
<body>
    <div id="content">
      ...
      <div class="main">
        <!-- FIRST WORK -->
        <p class="codepen" data-height="280" data-theme-id="light" data-default-tab="css,result" data-user="nadine-padernal" data-slug-hash="LYNOOvd" style="height: 280px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title=" CSS Skew">
          <span>See the Pen <a href="https://codepen.io/nadine-padernal/pen/LYNOOvd">
              CSS Skew</a> by nadine-padernal (<a href="https://codepen.io/nadine-padernal">@nadine-padernal</a>)
